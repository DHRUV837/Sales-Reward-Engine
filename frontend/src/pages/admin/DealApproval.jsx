    ...
    return (
        <SalesLayout>
            <div className="space-y-6">
                <PageHeader
                    heading="Deal Approval Management"
                    subtitle="Review, validate, and take action on submitted deals."
                    actions={
                    ...
                    <tbody className="divide-y divide-border-subtle">
                      ...
                      ${deal.status === 'Approved' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' :
                                                deal.status === 'Rejected' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' :
                                                    (deal.status === 'Submitted' || deal.status === 'Pending') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' :
